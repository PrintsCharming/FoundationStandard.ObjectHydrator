...
{
    public class UnitedKingdomPostCodeGenerator : IGenerator<string>
    {
        private readonly Random _random;
        private IList<string> _postcodePrefix = new List<string>();

        public UnitedKingdomPostCodeGenerator()
        {
